...
DISPLAY=:0 /usr/bin/chromium-browser --noerrdialogs --disable-infobars --autoplay-policy=no-user-gesture-required --disable-features=AudioServiceSandbox --kiosk 0.0.0.0:5552 &
